...
import microsoft.exchange.webservices.data.core.response.GetAppManifestsResponse;
import org.apache.commons.lang3.StringUtils;

/**
 * Created by yiyangli on 8/9/16.
 */
public class GetAppManifestsRequest extends SimpleServiceRequestBase<GetAppManifestsResponse> {
   ...
   * @throws Exception
   */
  public GetAppManifestsRequest(ExchangeService service) throws Exception {
    super(service);
  }
  ...
  @Override
  public GetAppManifestsResponse parseResponse(EwsServiceXmlReader reader) throws Exception {
   ...
   * @throws Exception the exception
   */
  public GetAppManifestsResponse execute() throws Exception{
    GetAppManifestsResponse serviceResponse = this.internalExecute();
